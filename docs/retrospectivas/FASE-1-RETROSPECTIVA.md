...
| Landmarks MediaPipe — refinamento fino pendente | `app/_shared/ml/roiExtractor.ts` | **PARCIALMENTE RESOLVIDO** (Fase 2, Bloco 4): problemas estruturais graves corrigidos (polígonos figura-8, holes de olhos errados, convenção paciente E/D). Bochechas ainda pequenas; nariz estreito. Refinar com múltiplas fotos após uso em consultório. | Baixo — ROIs anatômicamente corretas, impacto calibrável com dados reais |
