...
| Landmarks MediaPipe com índices aproximados | `app/_shared/ml/roiExtractor.ts` | Índices dos 478 landmarks foram mapeados por referência bibliográfica, não validados visualmente | Alto — validar visualmente no primeiro módulo que usa landmark |
